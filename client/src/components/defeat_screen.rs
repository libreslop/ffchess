            ...
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 100; text-align: center; width: 400px; color: #fff; animation: fadeIn 0.3s ease-out;">
                ...
                <div style="margin: 30px 0; display: flex; flex-direction: column; gap: 15px;">
                    <div style="padding: 15px;">
                        ...
                        <span style="font-size: 3em; font-weight: 900; color: #fff;">{props.score}</span>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px;">
                        <div style="padding: 10px;">
                            ...
                            <span style="font-size: 1.8em; font-weight: bold;">{props.kills}</span>
                        </div>
                        <div style="padding: 10px;">
                            <span style="display: block; font-size: 0.7em; text-transform: uppercase; color: #cbd5e1; letter-spacing: 1px;">{"Takes"}</span>
                            <span style="font-size: 1.8em; font-weight: bold;">{props.captured}</span>
                        </div>
                        <div style="padding: 10px;">
                            <span style="display: block; font-size: 0.7em; text-transform: uppercase; color: #cbd5e1; letter-spacing: 1px;">{"Survived"}</span>
                            <span style="font-size: 1.8em; font-weight: bold;">{format!("{}m {}s", props.survival_secs / 60, props.survival_secs % 60)}</span>
                        </div>
                    </div>
                </div>
