...
You are to make large scale refactors of the code base to optimise for what's specified in CODING STYLE, specifically
- breaking up files that are too large
